...
describe('calculateMaxDepth', () => {
  describe('when there are only 2 layers', () => {
    ...
    const actualResult = calculateMaxDepth(tasks, dependencies)

    it('the maximum depth should be 2', () => {
      const expectedResult = 2
  ...
  describe('when there are more than 2 layers', () => {
    ...
    it('the maximum depth should be 3', () => {
  ...
  describe('when some tasks are neither a successor nor a predecessor', () => {
    ...
    it('the maximum depth should include isolated tasks as depth 1', () => {
      const expectedResult = 3 // The depth of the main graph
